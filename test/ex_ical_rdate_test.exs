defmodule ExIcalRDATETest do
  ...
  test "event with RDATE PERIOD with empty spaces" do
    ical = """
    BEGIN:VCALENDAR
    CALSCALE:GREGORIAN
    VERSION:2.0
    ...
    RDATE;TZID=Europe/Berlin;VALUE=PERIOD:20230126T110000/20230126T130000,20
          230126T150000/20230126T170000,20230126T190000/20230126T210000
  ...
  test "event with RDATE PERIOD with new line" do
    ical = """
    BEGIN:VCALENDAR
    CALSCALE:GREGORIAN
    VERSION:2.0
